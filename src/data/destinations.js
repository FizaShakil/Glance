export const destinations = [
  ...
  },
  {
    ...
    tagline: "Terraced rice fields, temples, and surf",
    description:
      "An island of volcanic mountains, emerald rice terraces, and Hindu temples wrapped in morning mist. Bali balances surf-town energy in the south with quiet jungle retreats and traditional villages further inland.",
    image:
      "https://img.freepik.com/free-photo/beautiful-diamond-beach-penida-island-bali-indonesia_181624-41884.jpg",
    gallery: [
      ...
      "https://images.unsplash.com/photo-1493585686695-b8a71e2a055e?auto=format&fit=crop&w=1600&q=80",
    ],
  ...
  },
  {
    ...
    goodToKnow: [
      "Pick a season: green season offers rainbows and quieter roads.",
      "Driving 4x4 opens the best national parks.",
      "Spanish is spoken everywhere; English is common in tourist areas.",
    ],
  },
  {
    id: 4,
    ...
    gallery: [
      "https://images.unsplash.com/photo-1537956965359-7573183d1f57?auto=format&fit=crop&w=1600&q=80",
  ...
  },
  {
    ...
    country: "Mauritius",
    region: "Indian Ocean",
    tagline: "Reefs, rainforest, and French-Mauritian warmth",
    description:
      "An island nation east of Madagascar with a barrier reef shielding its sandy coves. Inland, sugarcane fields climb toward the Black River gorges, giving Mauritius both beach life and dramatic green interiors.",
    image:
      "https://img.freepik.com/free-photo/beautiful-scenery-chamarel-waterfall-mauritius-cloudy-sky_181624-19823.jpg",
    gallery: [
    ...
    about:
      "Mauritius is a reef-sheltered island east of Madagascar where French, Creole, Indian, and Chinese influences meet on one small table. The coast is lacework: protected coves, sugar-sand beaches, and lagoons the colour of drinking water. Inland, the landscape climbs through cane fields and gorges to the volcanic highlands of the Black River.",
    history:
    ...
    knownFor: ["Sugar-white beaches", "Reef-protected lagoons", "Chamarel park", "Creole cuisine"],
    goodToKnow: [
      "November to April is warm and humid; May to October is drier.",
      "A car unlocks the interior and the island's quieter corners.",
      "English and French are both widely spoken.",
    ],
  },
  {
    id: 6,
    slug: "hawaii",
    destName: "Hawaiian Islands",
    ...
    whyChoose: [
      ...
      "Matchless outdoor variety in a single state",
      "A rich, visible native culture woven into daily life",
    ],
  ...
  },
  {
    ...
    tagline: "Lemon groves and cliffside villages",
    description:
      "A dramatic stretch of Italy's southern coast where pastel villages cling to sheer cliffs above the Tyrrhenian Sea. Narrow roads wind between lemon groves, hidden coves, and views that made Positano world-famous.",
    image:
      "https://images.unsplash.com/photo-1761309557902-3bbfedbe67ad?auto=format&fit=crop&w=1600&q=80",
    gallery: [
  ...
  },
  {
    ...
    gallery: [
      ...
      "https://images.unsplash.com/photo-1610978883743-1b28f2b2d9f5?auto=format&fit=crop&w=1600&q=80",
      "https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?auto=format&fit=crop&w=1600&q=80",
    ],
  ...
  },
  {
    ...
    whyChoose: [
      ...
      "Four distinct seasons, each with its own famous view",
      "World-class food: kaiseki, tea ceremonies, and street-side ramen",
    ],
  ...
  },
  {
    id: 10,
    slug: "swiss-alps",
    destName: "The Swiss Alps",
    country: "Switzerland",
    region: "Europe",
    tagline: "Mountain air, glacier trails, and the Matterhorn's perfect peak",
    description:
      "A high-altitude playground around Zermatt and its neighbours, where the Matterhorn dominates the skyline, villages shut their streets to cars, and trains climb past waterfalls into snow all year round.",
    image:
  ...
  },
  {
    ...
    whyChoose: [
      ...
      "A moving, unmissable history at Robben Island and District Six",
      "Wildlife close at hand: penguins, whales, and great whites offshore",
    ],
    knownFor: ["Table Mountain cableway", "Cape of Good Hope", "Boulders Beach penguins", "Winelands (Stellenbosch)"],
    goodToKnow: [
  ...
  },
  {
    ...
    country: "Seychelles",
    region: "Indian Ocean",
    tagline: "Granite boulders, jade lagoons, and slow island living",
    description:
      "An archipelago of 115 granite and coral islands east of Africa, where sculpted boulders, powder-white beaches, and jungled hillsides make Seychelles one of the most photographable corners of the Indian Ocean.",
    image:
      "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=1600&q=80",
    gallery: [
    ...
    about:
      "Seychelles is the Indian Ocean's most dramatic archipelago: giant rounded granite boulders stacked on white sand, jungled hills wrapping hidden coves, and a slow island rhythm that makes you forget what day it is. Mahé, Praslin, and La Digue carry the classic postcard beaches, while the outer islands lean into wild, barefoot luxury.",
    history:
      "Uninhabited when first sighted by European explorers, Seychelles was settled by the French in the 18th century and later passed to the British, becoming independent in 1976. Its isolation preserved unique wildlife, including the coco de mer palm and a bird population found nowhere else on earth.",
    whyChoose: [
  ...
  },
  {
    ...
    gallery: [
      "https://images.unsplash.com/photo-1509087859087-a384654eca4d?auto=format&fit=crop&w=1600&q=80",
  ...
  },
  {
    ...
    gallery: [
      "https://images.unsplash.com/photo-1508186225823-0963cf9ab0de?auto=format&fit=crop&w=1600&q=80",
    ...
    whyChoose: [
      "Beaches for every mood, from party beaches to hidden coves",
      "Boat days out to the limestone towers of Phang Nga Bay",
      "A stylish historic old town off the tourist coach route",
      "Some of the best-value food in Southeast Asia",
    ],
  ...
  },
  {
    ...
    country: "Fiji",
    region: "South Pacific",
    tagline: "333 islands of coral, kava, and the warmth of 'bula'",
    description:
      "A South Pacific archipelago where the trademark 'bula' greeting sets the tone for barefoot days on coral-fringed beaches, village visits, and diving among some of the healthiest reefs on earth.",
    image:
      "https://images.unsplash.com/photo-1573843981267-be1999ff37cd?auto=format&fit=crop&w=1600&q=80",
    gallery: [
      "https://images.unsplash.com/photo-1508739773434-c26b3d09e071?auto=format&fit=crop&w=1600&q=80",
    ...
    knownFor: ["Mamanuca & Yasawa islands", "Soft coral reefs", "Kava ceremonies", "Fijian hospitality"],
    goodToKnow: [
      "Flights connect via Nadi; seaplanes and ferries reach the islands.",
      "High season is May–October; shoulder months balance sun and price.",
      "Visiting a village: remove hats, bring a gift, and accept the kava.",
    ],
  },
];
