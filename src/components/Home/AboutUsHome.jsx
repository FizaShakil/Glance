  ...
  return (
    <div>
        ...
        <div className='flex flex-row justify-around mt-7'>
            <div className='ml-[9%] hover:shadow-lg hover:shadow-black hover:ease-linear duration-300'>
               <img src={purpleHotelImage} alt="abotImage"
                     className='bg-cover w-[400px] rounded-xl ' />
            </div>
            <div className='w-[400px] mr-[9%]'>
